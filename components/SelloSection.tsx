...
export default function SelloSection() {
  const benefits = [
    ...
    "Prevención de patologías asociadas al trabajo",
            ...
            >
              ...
              <FadeIn delay={0.2}>
                <div className="flex flex-col items-center gap-4">
                  ...
                  >
                    <img src="/isologo-bordes-blancos.png" alt="PASE" className="w-12 h-auto" />
                  ...
                  <div className="flex flex-col gap-2 w-full max-w-[220px]">
                    <SelloBadge level="Nivel Inicial" stars={1} />
                    <SelloBadge level="Nivel Avanzado" stars={2} />
                    <SelloBadge level="Nivel Consolidado" stars={3} />
                  </div>
                </div>
              </FadeIn>
            </div>
            ...
            >
              <FadeIn delay={0.1} direction="left">
                ...
                <p className="text-base leading-relaxed mb-8" style={{ color: "#2F2F2F" }}>
                  Las empresas que implementan PASE obtienen un sello que certifica su compromiso activo con la
salud mental de las personas que forman parte de su negocio. Una evaluación anual mide sus
progresos y renueva el nivel de certificación.
                </p>
